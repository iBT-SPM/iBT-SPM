% Integrated Brain Analysis Toolbox for SPM: 'runinfo_own_template.m'
...
% statistically analyze in "own-space". 
...
%iBT.who.sub{sub}.sess{ses}.wild.raw =   ['sub-*_task-' iBT.who.sub{sub}.sess{ses}.name '_space-T1w_desc-preproc_bold????.nii'];	% wildcard for NIfTI fMRI images
%iBT.who.sub{sub}.sess{ses}.wild.r_ExplicitMask = ['sub-*_task-' iBT.who.sub{sub}.sess{ses}.name '_space-T1w_desc-brain_mask????.nii'];	% wildcard for NIfTI fMRI within-brain mask
