function y = ibt_nanstd(x,dim,flag)
% This is just a renamed version of nanstd from Jan Gl�scher's nansuite, to 
% include with IBT in a way that does not interfere with anyone's MATLAB functions.
% Originally obtained from http://www.mathworks.com/matlabcentral/fileexchange/6837-nan-suite
% Used here with the permission of Jan Gl�scher.
% No changes have been made below this line.
%
